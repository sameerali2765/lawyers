...
<head>
  ...
  <title>{{Session('aname')}}'s Persnol Dashboard</title>

  <!-- Favicons -->
  <link href="{{asset('images/icon/mainlogo.png')}}" rel="icon">
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="http://localhost:8000/AdminDashboard" class="logo"><b>Law<span>YER</span></b></a>
      <!--logo end-->
     
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="/LogoutAdmin">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered">{{Session::get('aname')}}</h5>
          <li class="mt">
            <a class="active" href=" http://localhost:8000/AdminDashboard">
              <i class="fa fa-dashboard"></i>
              <span>Dashboard</span>
              </a>
          </li>
          <li class="mt">
            <a href="http://localhost:8000/showlawyer" >
                <i class="fas fa-email"></i>Lawyers</a>
        </li>
        <li class="mt">
            <a href="http://localhost:8000/ShowProfile">
                <i class=""></i>Profiles</a>
        </li>
        <li class="mt">
            <a href="http://localhost:8000/client">
                <i class=""></i>Attorney</a>
        </li>
        <li class="mt">
            <a href="http://localhost:8000/showappointment">
                <i class=""></i>Appointments</a>
        </li>
        </ul>
        <!-- sidebar menu end-->
      </div>
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Lawyer</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Lawyer <a href="http://localhost:8000/AdminDashboard">lawyer.com</a>
        </div>
        <a href="http://localhost:8000/AdminDashboard" class="go-top">
